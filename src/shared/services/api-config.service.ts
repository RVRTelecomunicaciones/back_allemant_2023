...
export class ApiConfigService {
    ...
    get publicKeyToken(): string {
        return this.getString('publicKeyToken');
    }

    get privateKeyToken(): string {
        return this.getString('privateKeyToken');
    }
    ...
    get authConfig() {
        return {
            privateKeyToken: this.getString('JWT_PRIVATE_KEY') as string,
            publicKeyToken: this.getString('JWT_PUBLIC_KEY') as string,
            jwtTokenSecret: this.getString('jwtTokenSecret'),
            jwtRefreshTokenSecret: this.getString('jwtRefreshTokenSecret'),
            jwtExpirationTime: this.getNumber('JWT_EXPIRATION_TIME'),
            jwtRefreshTokenExpirationTime: this.getNumber('JWT_REFRESH_EXPIRATION_TIME'),
        };
    }
