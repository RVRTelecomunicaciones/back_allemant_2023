...
class PageOptionsDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { order: { required: false, default: Order.DESC, enum: require("./page-metaoption.dto").Order }, page: { required: false, type: () => Number, default: 1, minimum: 1 }, take: { required: false, type: () => Number, default: 10, minimum: 1, maximum: 50 } };
    }
}
__decorate([
...
//# sourceMappingURL=page-metaoption.dto.js.map