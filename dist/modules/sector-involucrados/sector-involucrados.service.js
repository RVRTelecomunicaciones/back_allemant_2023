...
exports.SectorInvolucradosService = void 0;
...
let SectorInvolucradosService = class SectorInvolucradosService {
    ...
    async createSectorInvolucrado(createDto) {
        ...
        if (findNameResult) {
            throw new common_1.HttpException(`${nombre} el Sector de Involucrados actual ya existe y no se puede crear repetidamente`, common_1.HttpStatus.OK);
        }
        const sectorInvolucrado = this.repository.create(createDto);
        await this.repository.save(sectorInvolucrado);
        return 'Sector de Involucrados creado con éxito';
    }
    async updateSectorInvolucradoById(id, updateDto) {
        ...
        if (!existSectorInvolucrado) {
            throw new common_1.NotFoundException(`Sector id ${id} no existe`);
        }
    ...
    async deleteSectorInvolucrado(id) {
        const existSectorInvolucrado = await this.repository.findOne({ where: { id: id } });
        if (!existSectorInvolucrado) {
            throw new common_1.HttpException(`Sector con id ${id} no existe`, common_1.HttpStatus.OK);
        }
...
SectorInvolucradosService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(sector_involucrado_entity_1.SectorInvolucrado)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], SectorInvolucradosService);
exports.SectorInvolucradosService = SectorInvolucradosService;
//# sourceMappingURL=sector-involucrados.service.js.map