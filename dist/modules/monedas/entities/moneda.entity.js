...
let Moneda = class Moneda extends shared_entity_1.SharedEntity {
    static _OPENAPI_METADATA_FACTORY() {
        return { codigo: { required: true, type: () => String }, simbolo: { required: true, type: () => String }, nombre: { required: true, type: () => String } };
    }
};
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', nullable: false, length: 3, name: 'codigo' }),
    __metadata("design:type", String)
], Moneda.prototype, "codigo", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', nullable: false, length: 10, name: 'simbolo' }),
    __metadata("design:type", String)
], Moneda.prototype, "simbolo", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', nullable: false, length: 25, name: 'nombre' }),
    __metadata("design:type", String)
], Moneda.prototype, "nombre", void 0);
Moneda = __decorate([
    (0, typeorm_1.Entity)('co_moneda')
], Moneda);
